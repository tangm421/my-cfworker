 ...
 *  Test Blog
 *
 *  https://github.com/tangm421/my-cfworker
 *
 */

// 定义 Github 项目，文章会从这里读取
const github_base = "tangm421/my-cfworker";

// 设置站点信息
var default_title	 = "Tangm421's Personal Blog";					// 站点标题（显示在浏览器标题栏）
var default_intitle	 = "- Tangm421's Personal Blog -";								// 站点名称（显示在首页）
var site_subtitle	 = "Powerd by CloudFlare Worker";							// 站点副标题
var default_description  = "A custom blog powerd by cloudflare worker"; 	// 站点简介，有利于 SEO
var site_domain		 = "myblog.luanhui.cf";								// 站点域名
var site_favicon	 = "https://pic.cnblogs.com/avatar/1703382/20201126112551.png";				// 站点 Logo

// Copyright
const copyright = `&copy; 2021 ${site_subtitle} | <a href="https://github.com/tangm421/my-cfworker" target="_blank">Github</a>`;

// 博主信息
var owner_name = "tangm421";									// 博主名字
var owner_logo = "https://pic.cnblogs.com/avatar/1703382/20201126112551.png"	// 博主头像
var owner_desc = "C++er | 前端懵逼大师 | 反996";					// 博主简介
...
async function bloghandle(request) {
	...
	if(urls.pathname == "/") {
		...
		if(response.status == 200) {
			...
			data += `</textarea>
					<hr>
					<!-- disable comments <div id="comments">评论区加载中 qwq</div>  -->
				`;
		} else {
			data += `### 404 Not Found
未找到您访问的页面，原因可能是：
	...
	data += `</div>
				<div class="col-sm-3">
					<div style="padding: 16px;text-align: center;">
						...
						<div class="text-left">
							<h4>友情链接</h4>
							<p><a href="" target="_blank">虚位以待</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- disable comments <script src="https://comments.zerodream.net/comments.js?s=2"></script> -->
		<script type="text/javascript">
			...
			window.onload = function() {
				try {
					...
					<!-- disable comments CommentsInit(comments, init); -->
				} catch(e) {}
			}
		</script>
